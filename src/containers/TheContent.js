...
const TheContent = props => {
  ...
  const changedFullScreenModeRef = useRef(false)
  ...
  useEffect(() => {
    if (changedFullScreenModeRef.current != changedFullScreenMode) {
    ...
    changedFullScreenModeRef.current = changedFullScreenMode
