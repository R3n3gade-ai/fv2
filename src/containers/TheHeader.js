...
const TheHeader = props => {
  ...
  return (
    <CHeader withSubheader>
      ...
      <CHeaderNav className="mr-auto ft-left-nav">
        {!userHasCancelled && 
          <>
            <CToggler
              inHeader
              className={isMobile ? `` : `mr-3` + ` second-step`}
            ...
            >
              { asideShow && 
                <>
                  ...
                  {!isMobile && <span className='font-weight-bold'>&nbsp;Divergence</span>}
                </>
              }
              { !asideShow && 
                <>
                  <CIcon name="cil-call-split" alt="Dashboard" />
                  {!isMobile && <span>&nbsp;Divergence</span>}
                </>
              }
            </CToggler>
            <CToggler
              inHeader
              className={isMobile ? `` : `mr-3` + ` third-step`}
            ...
            >
              { scanAsideShow && 
                <>
                  ...
                  {!isMobile && <span className='font-weight-bold'>&nbsp;Scan</span>}
                </>
              }
              { !scanAsideShow && 
                <>
            ...
            <CToggler
              inHeader
              className={isMobile ? `` : `mr-3` + ` fourth-step`}
            ...
            >
              { watchlistAsideShow && 
                <>
                  ...
                  {!isMobile && <span className='font-weight-bold'>&nbsp;Watchlist</span>}
                </>
              }
              { !watchlistAsideShow && 
                <>
                  <CIcon name="cil-queue" alt="Dashboard" />
                  {!isMobile && <span>&nbsp;Watchlist</span>}
                </>
              }
            </CToggler>
            <CToggler
            ...
            >
              { integrationsAsideShow &&
                <>
                  ...
                  {!isMobile && <span className='font-weight-bold'>&nbsp;Integrations</span>}
                </>
              }
              { !integrationsAsideShow &&
                <>
