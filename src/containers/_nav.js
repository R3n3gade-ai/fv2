...
const _nav = [
  ...
  },
  {
    ...
    icon: <CIcon content={React.icons.cilCalendar} customClasses="c-sidebar-nav-icon"/>
  },
  {
    _tag: 'CSidebarNavItem',
    name: 'Stock Trends',
    to: '/stocktrends',
    className: '',
    icon: <CIcon content={React.icons.cilSpeedometer} customClasses="c-sidebar-nav-icon"/>
  },
  {
    _tag: 'CSidebarNavTitle',
    _children: ['Account']
