...
let app = admin.app();
let polyData = functions.database.instance('tradingproject25-f513b-e8221tickersfl-e8221');
...
exports.findDivergencesFl = polyData.ref('1m/{stockId}/{stockDay}').onWrite(checkSpikeV2)
