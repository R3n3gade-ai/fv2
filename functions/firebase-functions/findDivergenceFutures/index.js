...
let app = admin.app();
let futuresData = functions.database.instance('tradingproject25-futures');
let futuresDbRef = app.database('https://tradingproject25-futures-tracking.firebaseio.com');

exports.findDivergencesFutures = futuresData.ref('1m/{stockId}/{stockDay}').onWrite(checkSpikeV2)
    ...
    if (xdata != null) {
        ...
        for (let bb in xdata) {
            ...
            if (xdata[bb].O != 0 && MO == 0) {
                ...
                if (bb == topminute) {
                    futuresDbRef.ref("MO/" + context.params.stockId).set(MO);
                }
            }
            ...
            if (MO != 0) {
                if (parseInt(topminute) == parseInt(bb)) {
                    if (parseFloat(xdata[bb].O) > parseFloat(MO) * 1.05) {
                        ...
                        futuresDbRef.ref(n + "/" + xsize + 'gainers/' + context.params.stockId).set({
                            MO: MO,
                            T: bb,
                            C: xdata[bb].C
                        });
                    ...
                    if (parseFloat(xdata[bb].O) < parseFloat(MO) * .95) {
                        ...
                        futuresDbRef.ref(n + "/" + xsize + 'losers/' + context.params.stockId).set({
                            MO: MO,
                            T: bb,
                            C: xdata[bb].C
                        });
                    ...
                    if (xA > 10000 * multiplier) {
                        if (trendAlgo > 7 && trendPrice < -6) {
                            ...
                            if (isTruely15Down(xdata, bb)) {
                                if (parseInt(topminute) == parseInt(bb)) {
                                    futuresDbRef.ref(n + "/" + xsize + 'divergencePriceDown/15/' + context.params.stockId + "/" + bb).set(true);
                                    futuresDbRef.ref(n + "/" + xsize + 'divergence/' + context.params.stockId + '/PriceDown/15/' + bb).set(true);
                                    ...
                                    futuresDbRef.ref(n + "/" + xsize + 'latest/priceDown/15').push(kelts);
                                }
                            }
                        }
                        ...
                        if (trendAlgo < -7 && trendPrice > 6) {
                            ...
                            if (parseInt(topminute) == parseInt(bb)) {
                                ...
                                if (isTruely15Up(xdata, bb)) {
                                    futuresDbRef.ref(n + "/" + xsize + 'divergencePriceUp/15/' + context.params.stockId + "/" + bb).set(true);
                                    futuresDbRef.ref(n + "/" + xsize + 'divergence/' + context.params.stockId + '/PriceUp/15/' + bb).set(true);
                                    ...
                                    kelts.tA30 = trendAlgo30
                                    kelts.tP30 = trendPrice30
                                    futuresDbRef.ref(n + "/" + xsize + 'latest/priceUp/15').push(kelts);
                                }
                            }
                        }
                    }
                    ...
                    if (lastfound30 + 10 < xcount) {
                        if (trendAlgo30 > 10 && trendPrice30 < -8) {
                            ...
                            if (isTruely30Down(xdata, bb)) {
                                lastfound30 = xcount;
                                if (parseInt(topminute) == parseInt(bb)) {
                                    futuresDbRef.ref(n + "/" + xsize + 'divergencePriceDown/30/' + context.params.stockId + "/" + bb).set(true);
                                    futuresDbRef.ref(n + "/" + xsize + 'divergence/' + context.params.stockId + '/PriceDown/30/' + bb).set(true);
                                    let kelts = calcKeltData(xdata)
                                    kelts.c = xdata[bb].L;
                                    kelts.s = context.params.stockId;
                                    kelts.t = bb
                                    ...
                                    kelts.tA30 = trendAlgo30
                                    kelts.tP30 = trendPrice30
                                    futuresDbRef.ref(n + "/" + xsize + 'latest/priceDown/30').push(kelts);
                                }
                            }
                        }
                        ...
                        if (trendAlgo30 < -10 && trendPrice30 > 8) {
                            ...
                            if (isTruely30Up(xdata, bb)) {
                                lastfound30 = xcount;
                                if (parseInt(topminute) == parseInt(bb)) {
                                    futuresDbRef.ref(n + "/" + xsize + 'divergencePriceUp/30/' + context.params.stockId + "/" + bb).set(true);
                                    futuresDbRef.ref(n + "/" + xsize + 'divergence/' + context.params.stockId + '/PriceUp/30/' + bb).set(true);
                                    let kelts = calcKeltData(xdata)
                                    kelts.c = xdata[bb].L;
                                    kelts.s = context.params.stockId;
                                    kelts.t = bb
                                    ...
                                    futuresDbRef.ref(n + "/" + xsize + 'latest/priceUp/30').push(kelts);
                                }
                            }
                        }
                    }
