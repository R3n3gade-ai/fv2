...
let app = admin.app();
let polyData = functions.database.instance('tradingproject25-f513b-e8221tickersms-e8221');
...
exports.findDivergencesMs = polyData.ref('1m/{stockId}/{stockDay}').onWrite(checkSpikeV2)
