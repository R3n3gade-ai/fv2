...
let app = admin.app();
let polyData = functions.database.instance('tradingproject25-f513b-e8221tickersae-e8221');
...
exports.findDivergencesAe = polyData.ref('1m/{stockId}/{stockDay}').onWrite(checkSpikeV2)
